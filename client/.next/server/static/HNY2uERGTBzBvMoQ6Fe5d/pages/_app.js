...
const initalState = {
  ...
  Navbar: 2,
  SSID: "",
  BirdDay: external_moment_default()().format("MMM Do YY"),
  PostId: "",
  time: 0,
  token: null,
  loadding: false,
...
const postReducer = (state = initalState, action) => {
  switch (action.type) {
    case types["g" /* UPDATE_TYPEBLAND */]:
      return _objectSpread(_objectSpread({}, state), {}, {
        TypeBland: action.payload
      });

    case types["b" /* UPDATE_NAVBAR */]:
      return _objectSpread(_objectSpread({}, state), {}, {
        Navbar: action.payload
      });

    case types["d" /* UPDATE_SSID */]:
      return _objectSpread(_objectSpread({}, state), {}, {
        SSID: action.payload
      });

    case types["a" /* UPDATE_BIRD */]:
      return _objectSpread(_objectSpread({}, state), {}, {
        BirdDay: external_moment_default()(action.payload).format("MMM Do YY")
      });

    case types["c" /* UPDATE_POST */]:
      return _objectSpread(_objectSpread({}, state), {}, {
        PostId: action.payload
      });

    case types["e" /* UPDATE_TIME */]:
      return _objectSpread(_objectSpread({}, state), {}, {
        time: action.payload
      });

    case types["f" /* UPDATE_TOKEN */]:
      return _objectSpread(_objectSpread({}, state), {}, {
...
const MyApp = ({
  ...
  Object(external_react_["useEffect"])(() => {
    ...
    router_default.a.events.on("routeChangeComplete", handleRouteChange);
    return () => {
      router_default.a.events.off("routeChangeComplete", handleRouteChange);
    };
  }, []);
